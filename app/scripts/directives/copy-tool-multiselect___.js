...
angular.module("multiselectcopytool", ["multiselectcopytool.tpl.html"])
//from bootstrap-ui typeahead parser
    ...
    .directive("multiselectPopup2", ["$document", function ($document) {
        return {
            ...
            scope: false,
            replace: true,
            templateUrl: "multiselectcopytool.tpl.html",
...
angular.module("multiselectcopytool.tpl.html", []).run(["$templateCache", function ($templateCache) {
    $templateCache.put("multiselectcopytool.tpl.html",
        "<div class=\"btn-group\">\n" +
        ...
        "    <div ng-style=\"maxWidth\" style=\"padding-right: 13px; overflow: hidden; float:left; text-overflow: ellipsis;width:100%;text-align: left;\">{{header}}</div><span class=\"caret\" style=\"position:absolute;right:10px;top:14px;\"></span>\n" +
        "  </button>\n" +
        ...
        "      <a ng-click=\"onCourseChkUpdate()\" style=\"padding:3px 10px;cursor:pointer;\">\n" +
