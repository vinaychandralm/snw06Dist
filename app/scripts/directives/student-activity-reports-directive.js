...
angular.module("multiselect.tpl.html", []).run(["$templateCache", function ($templateCache) {
    $templateCache.put("multiselect.tpl.html",
        ...
        "    <div ng-style=\"maxWidth\" style=\"padding-right: 13px; overflow: hidden; float:left; text-overflow: ellipsis;width:100%\">{{header}}</div><span class=\"caret\" style=\"position:absolute;right:10px;top:14px;\"></span>\n" +
        "  </button>\n" +
